...
public class TableBuilder {
	/**
	 * TABLE_MAGIC_NUMBER was picked by running echo
	 * http://code.google.com/p/leveldb/ | sha1sum and taking the leading 64
	 * bits.
	 */
	...
	private BlockHandle writeBlock(BlockBuilder blockBuilder) throws IOException {
		...
		BlockTrailer blockTrailer = new BlockTrailer(crc32c(blockContents));
	...
	public static int crc32c(Slice data) {
